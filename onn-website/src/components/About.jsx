...
const About = () => {
    ...
    return (
        <div name='about' className='w-full h-fit md:h-screen
        bg-gray-900 text-white'>
            <div className='flex flex-col items-center justify-center max-w-screen-xl mx-auto h-full px-3 py-12'>
                <div className='text-center'>
                    ...
                    <p className='text-xl text-gray-500 font-light py-8'>Door with mien stepped perched we name into youhere, i much both by this thy flung. Visiter that ember what than, doubting shall evermore him wrought prophet heard evermore. Tapping i form many melancholy thereat.</p>
                </div>
